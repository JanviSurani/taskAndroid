...
class ViewCustomMarker : AppCompatActivity(),  OnMapReadyCallback {

    private var mapFragment:SupportMapFragment?=null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_view_custom_marker)
    ...
    private  fun viewToBitmap(view: View):Bitmap?{
        ...
        view.layout(0,0,view.measuredHeight,view.measuredWidth)
        view.draw(canvas)
        return  bitmap
