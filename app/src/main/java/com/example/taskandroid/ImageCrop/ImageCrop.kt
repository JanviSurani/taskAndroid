package com.example.taskandroid.ImageCrop
...
class ImageCrop: AppCompatActivity() {
    ...
    private fun openDialog() {
        val openDialog = AlertDialog.Builder(this@ImageCrop)
        openDialog.setIcon(R.drawable.ic_menu_camera)
...
//    }
    ...
    private fun enableRuntimePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(
                this@ImageCrop,Manifest.permission.CAMERA
            )){
            Toast.makeText(this@ImageCrop,
                "Camera Permission allows us to Camera App",
                Toast.LENGTH_SHORT).show()
        }
        else{
            ActivityCompat.requestPermissions(this@ImageCrop,
